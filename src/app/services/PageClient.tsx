...
export default function Services({ page_content_json, pageContent }: { page_content_json: Pick<typeof import("@/data/db_fallback.json"), "page_content_service">; pageContent: PageContent }) {
