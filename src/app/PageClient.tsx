...
export default function Home({ page_content_json, pageContent }: { page_content_json: Pick<typeof import("@/data/db_fallback.json"), "page_content_home" | "services_catalog" | "valueProps">; pageContent: PageContent }) {
