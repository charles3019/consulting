...
export default function Skills({ page_content_json, pageContent }: { page_content_json: Pick<typeof import("@/data/db_fallback.json"), "page_content_Skill">; pageContent: PageContent }) {
